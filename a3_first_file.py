...
def run_experiment(algorithm, data, args):
    ...
    print('Average objective:', average_objective)
    print('Feasible runs:', feasible_tally)
    ...
    if not args.test:
        ...
        new_results += f"Feasible runs: {feasible_tally}\n"
        new_results += f"Infeasible causes and counts: {infeas_counts}\n"
        new_results += "------------------\n"
